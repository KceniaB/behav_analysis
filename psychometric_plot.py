...
# %% 
"""
Load and plot different sessions 
""" 
#%% 
"""
KceniaBougrova 
...
def plot_psychometric(trials, ax=None, title=None, **kwargs):
    ...
    ax.legend([fit_50[0], data_50, fit_20[0], data_20, fit_80[0], data_80],
              ...
              loc='lower right',
              fontsize=8) 
    #ax.text(-105, 0.95, eid+"\n"+"D5", color='#ADB6C4', fontsize=6, #style='italic',
    ax.text(-105, 0.95, ref.subject + '\n' + str(ref.date), color='#ADB6C4', fontsize=6, #style='italic',
    #ax.text(-105, 0.95, ref.subject + '\n' + str(ref.date) + '\n' + str(performance_1), color='#ADB6C4', fontsize=6, #style='italic',

        #bbox={'facecolor': 'red', 'alpha': 0.5, 'pad': 1} 
        #bbox={'facecolor': 'white', 'alpha': 0.5, 'pad': 1.5}
        )
    ax.set_ylim(-0.05, 1.05)
    ax.set_ylabel('Probability choosing right')
    ax.set_xlabel('Contrasts') 
...
#for eid in eids[1:3]: 
    ...
    performance_2 = contrasts 
    performance_3 = n_contrasts
    performance, contrasts, n_contrasts = compute_performance(trials, prob_right=True)
    performance, contrasts, n_contrasts = compute_performance(trials, block=0.8)
